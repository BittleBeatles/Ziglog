...
public interface NotificationService {
    ...
    void consumeKafkaEvent(NotificationKafkaDto notificationKafkaDto) throws Exception;
    void saveKafkaEventIntoRDB(NotificationKafkaDto notification) throws Exception;
}
