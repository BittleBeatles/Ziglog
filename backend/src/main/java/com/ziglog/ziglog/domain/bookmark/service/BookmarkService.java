...
public interface BookmarkService {
    ...
    //북마크 추가
    void addBookmark(Member member, Long noteId) throws UserNotFoundException, NoteNotFoundException, BookmarkAlreadyExistsException;
    //북마크 삭제
    ...
    //북마크 가져오기
    List<Note> getBookmarkedNotes(Member member) throws UserNotFoundException;
    //이 글이 북마크 된 글인지 확인
